...
```
python api_request_parallel_processor.py                                                                                     --requests_filepath uspto_requests.json                                                                                              --save_filepath results_uspto_requests.json                                                                                          --request_url https://api.openai.com/v1/chat/completions                                                                        --max_requests_per_minute 20                                                                                       --max_tokens_per_minute 6250000                                                                                      --token_encoding_name gpt-3.5-turbo                                                                                                    --max_attempts 5                                                                                                               --logging_level 20
```

```
python api_request_parallel_processor.py \
  --requests_filepath example_requests_to_parallel_process.jsonl \
  --save_filepath example_requests_to_parallel_process_results.jsonl \
...
if __name__ == "__main__":
    ...
    parser.add_argument("--token_encoding_name", default="gpt-4")
